...
static const std::int16_t MACEtab3[] = {-18, 140, 140, -18};

static const std::int16_t MACEtab2[][4] = {
...
static const std::int16_t MACEtab4[][2] = {
...
static const struct
{
    const std::int16_t *tab1;
    const std::int16_t *tab2;
    int stride;
} tabs[] = {
...
struct ChannelData
{
    std::int16_t index, factor, prev2, previous, level;
};
...
static std::int16_t read_table(ChannelData* chd, uint8_t val, int tab_idx)
{
    std::int16_t current;
